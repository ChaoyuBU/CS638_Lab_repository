...
class ProjectPortalProvider: ContentProvider() {
    ...
    fun constructProject(contentValue:ContentValues): Project {
        ...
        contentValue.getAsString(PROJECT_DESC),
            contentValue.getAsString(PROJECT_AUTHOR),
            contentValue.getAsString(PROJECT_LINK),
            contentValue.getAsBoolean(PROJECT_ISFAV.toString()),
            contentValue.getAsString(PROJECT_KEYWORD),
            contentValue.getAsString(PROJECT_ADDITIONAL)
        )
    ...
    companion object{
        ...
        val PROJECT_AUTHOR = "author"
        val PROJECT_LINK = "link"
        val PROJECT_ISFAV = false
        val PROJECT_KEYWORD = "keyword"
        val PROJECT_ADDITIONAL= "additional"
